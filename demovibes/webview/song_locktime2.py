...
# considered good and song ratings lower than 3.3 are considered bad.  However,
# these values also depend on the maximum lock time compared to the minimum
# lock time.  If the longest lock time is much larger than the shortest time,
# you may want to use largish negative bias values.
hBiasBase = -0.75
...
# Songs with highest rating but different vote counts
